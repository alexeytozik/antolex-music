...
3. A PostgreSQL-backed media job verifies the uploaded hash, reads tags and embedded artwork, and produces an M4A AAC-LC 256 kbit/s playback copy with `faststart`.
